...
- Generate schemas data <br />
  `npm run generate`
- Generate jsdoc (tsdoc) <br />
  `npm run doc`
- Run dev server <br />
  `npm run dev`
...
`./src/generated` -- folder contains schemas generated by codegen.
...
- Add loader at the top, controlled globally <br />
- Single post page <br/>
- Tag search <br/>
- Add types and interfaces members ordering rule <br />
...
- Copyright 2021 © <a href="https://github.com/iivanovw7/personal-website" target="_blank">personal-website</a>
