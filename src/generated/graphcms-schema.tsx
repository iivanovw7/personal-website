...
export type Post = Node & {
  ...
  /** Post text without formatting */
  basicText?: Maybe<Scalars['String']>;
...
export type PostManyWhereInput = {
  ...
  basicText?: Maybe<Scalars['String']>;
  /** All values that are not equal to given value. */
  basicText_not?: Maybe<Scalars['String']>;
  /** All values that are contained in given list. */
  basicText_in?: Maybe<Array<Scalars['String']>>;
  /** All values that are not contained in given list. */
  basicText_not_in?: Maybe<Array<Scalars['String']>>;
  /** All values containing the given string. */
  basicText_contains?: Maybe<Scalars['String']>;
  /** All values not containing the given string. */
  basicText_not_contains?: Maybe<Scalars['String']>;
  /** All values starting with the given string. */
  basicText_starts_with?: Maybe<Scalars['String']>;
  /** All values not starting with the given string. */
  basicText_not_starts_with?: Maybe<Scalars['String']>;
  /** All values ending with the given string. */
  basicText_ends_with?: Maybe<Scalars['String']>;
  /** All values not ending with the given string */
  basicText_not_ends_with?: Maybe<Scalars['String']>;
...
export enum PostOrderByInput {
  ...
  BasicTextAsc = 'basicText_ASC',
  BasicTextDesc = 'basicText_DESC',
  TagsAsc = 'tags_ASC',
  TagsDesc = 'tags_DESC'
}
...
export type GetPostsQuery = (
  ...
  & { posts: Array<(
    { __typename?: 'Post' }
    & Pick<Post, 'createdAt' | 'date' | 'excerpt' | 'id' | 'subject' | 'tags' | 'title' | 'updatedAt'>
    & AuthorFragment
  )> }
);
...
export type GetPostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'basicText' | 'createdAt' | 'date' | 'excerpt' | 'id' | 'subject' | 'tags' | 'title' | 'updatedAt'>
    & { content: (
      { __typename?: 'RichText' }
      & Pick<RichText, 'html'>
    ) }
